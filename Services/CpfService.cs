public class CpfService
{
    ...
    {
        string lastDigits = cpf.Substring(9, 2);
        string validatedDigits = getValidationDigits(cpf);
        return lastDigits == validatedDigits;
    }
    ...
    public string Generate()
    {
        ...
        string lastDigits = getValidationDigits(cpf9digits);
        return cpf + "-" + lastDigits;
    }
